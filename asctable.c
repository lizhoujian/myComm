...
//#define ASC_TEXT_COLOR		RGB(255,0,0)		//字体颜色:红色
...
int ShowAsciiTable(void)
{
    ...
    RegisterClassEx(&wcx);
    hWndAsciiTable = CreateWindowEx(0, "AsciiTable", "ASCII 码表(鼠标右键可换颜色)",
    ...
    //utils.center_window(hWndAsciiTable,msg.hWndMain);
